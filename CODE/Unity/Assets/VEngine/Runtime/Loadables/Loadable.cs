...
namespace VEngine
{
    ...
    public class Loadable
    {
        ...
        ///     加载路径
        /// </summary>
        protected internal string pathOrURL { get; set; }
        ...
        protected bool keepAliveOnLoad { get; set; }
        ...
        public void Release()
        {
            ...
            {
                Logger.W("Release {0} {1}.", GetType().Name, pathOrURL);
                return;
            }
            ...
            Logger.I("Release {0} {1}.", GetType().Name, pathOrURL);
            reference.Release();
            if (!reference.unused)
            {
                return;
