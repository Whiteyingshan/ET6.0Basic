...
namespace VEngine.Editor
{
    ...
    public sealed class Settings : ScriptableObject
    {
        ...
        ///     编辑器打包后的数据输出目录
        /// </summary>
        public static readonly string buildDataPath = GetDataPath("Build");
        ...
        /// <summary>
        ///     打包 AB 的选项具体参考官方的脚步API
        /// </summary>
        [Tooltip("打包AssetBundle的操作")] public BuildAssetBundleOptions buildAssetBundleOptions =
        ...
        ///     启动场景
        /// </summary>
        [Tooltip("启动场景")] public SceneAsset startupScene;


        /// <summary>
        ///     打包播放器的收用来替换 PlayerSettings 中的 ScenesInBuild
        /// </summary>
        public string[] scenesInBuild
        {
            get
            {
                return new[]
                {
                    AssetDatabase.GetAssetPath(startupScene)
                };
            }
        }
        ...
        public static string GetBuildDataPath(string file)
        {
            return $"{buildDataPath}/{file}";
        }
