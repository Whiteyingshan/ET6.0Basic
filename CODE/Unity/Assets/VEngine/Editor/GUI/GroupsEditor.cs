...
namespace VEngine.Editor
{
    ...
    public class GroupsEditor
    {
        ...
        private void DrawBuild()
        {
            ...
            {
                var menu = new GenericMenu();
                menu.AddItem(new GUIContent("Groups"), false, data =>
                {
                ...
                menu.AddItem(new GUIContent("Manifest"), false, data =>
                {
                    var manifest = settings.manifests[selected];
                ...
                menu.AddSeparator("");
                menu.AddItem(Constants.BuildGroups, false, _ =>
                {
                ...
                menu.AddItem(Constants.BuildManifests, false, _ =>
                {
        ...
        private void DrawView()
        {
                ...
                EditorStyles.toolbarDropDown))
            {
                ...
                menu.AddItem(new GUIContent("Build"), false,
                    _ => { EditorUtility.PingWithSelected(settings.manifests[selected].GetBuild()); },
                    null);
        ...
        public static class Constants
        {
            ...
            public static readonly GUIContent BuildGroups = new GUIContent("All Groups", "构建分组，不生成 AssetBundles");
            public static readonly GUIContent BuildBundles = new GUIContent("All Bundles", "构建资源，并生成对应的 AssetBundles");
            public static readonly GUIContent BuildManifests = new GUIContent("All Manifests", "构建清单，打包后才能使用");
