...
namespace ET
{
    ...
    public partial class StartMachineConfigCategory : ProtoObject
    {
        ...
        [ProtoIgnore]
        [BsonIgnore]
        private Dictionary<long, StartMachineConfig> dict = new Dictionary<long, StartMachineConfig>();
        ...
        public StartMachineConfig Get(long id)
        {
        ...
        public Dictionary<long, StartMachineConfig> GetAll()
        {
            return this.dict;
        }
