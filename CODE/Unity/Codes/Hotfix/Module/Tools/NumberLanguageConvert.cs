...
namespace ET
{
    ...
    /// 语言转换工具
    /// </summary>
    public static class NumberLanguageConvert
    {
        /// <summary>
        /// 数字单位转换为M为单位
        /// </summary>
        ...
        /// <returns></returns>
        public static string NumUnitConversionToString(long number)
        {
            if (number > 10000)
            {
                return (number / 10000f).ToString("0.0") + "万";
            }
