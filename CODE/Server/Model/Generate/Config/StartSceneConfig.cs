...
namespace ET
{
    ...
    public partial class StartSceneConfigCategory : ProtoObject
    {
        ...
        [ProtoIgnore]
        [BsonIgnore]
        private Dictionary<long, StartSceneConfig> dict = new Dictionary<long, StartSceneConfig>();
        ...
        public StartSceneConfig Get(long id)
        {
        ...
        public Dictionary<long, StartSceneConfig> GetAll()
        {
            return this.dict;
        }
